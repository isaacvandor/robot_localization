...
class ParticleFilter(object):
    ...
    def __init__(self):
        ...
        rospy.init_node('localizer')           # tell roscore that we are creating a new node named "pf"
    ...
    def update_particles_with_odom(self, msg):
        ...
        odom_noise = .5 # level of noise put into particles after update from odom to introduce variability
    ...
    def fix_map_to_odom_transform(self, msg):
        """ This method constantly updates the offset of the map and
            ...
            the localizer"""
        (translation, rotation) = self.transform_helper.convert_pose_inverse_transform(self.robot_pose)
        p = PoseStamped(pose=self.transform_helper.convert_translation_rotation_to_pose(translation,rotation),
